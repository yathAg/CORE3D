...
def export(
        ...
        output_file=None,
        label_to="nyu40id",
        apply_axis_alignment: bool = False):
    ...
    if apply_axis_alignment and meta_file is not None:
        # Load scene axis alignment matrix
        axis_align_matrix = read_axis_align_matrix(meta_file)
        if axis_align_matrix is not None:
            axis_align_matrix = axis_align_matrix.numpy()
...
def read_one_scan(scannet_dir, scan_name, label_map_file, label_to="nyu40id",
    ...
    mesh_vertices, semantic_labels, instance_labels, instance_bboxes, instance2semantic = export(
        ...
        None,
        label_to=label_to,
        apply_axis_alignment=axis_align)
