...
class PanopticSegmentationModule(SemanticSegmentationModule):
    ...
    def forward(
        ...
        if edge_index.numel() > 0:
            ...
            if mn < 0 or mx >= n:
                raise RuntimeError(
                    f"obj_edge_index out of bounds: [{mn},{mx}] vs n={n}")
        x_edge = x[edge_index]
        x_edge = torch.cat(
    ...
    def on_train_epoch_end(self) -> None:
        ...
        if self.needs_partition:
            ...
            if self.needs_instance:
                ...
                map_25 = instance_results.map_25
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        if self.needs_partition:
            ...
            if self.needs_instance:
                ...
                self.log("val/map_25", 100 * map_25, prog_bar=True)
    ...
    def on_test_epoch_end(self) -> None:
        ...
        if self.needs_partition:
            ...
            if self.needs_instance:
                ...
                self.log("test/map_25", 100 * map_25, prog_bar=True)
